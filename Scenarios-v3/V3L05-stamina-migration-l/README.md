...
# V3L05 Stamina Migration (L variant)
...
| Check | Command |
|---|---|
| oracle JSON parse | `python -c "import json; json.load(open('Scenarios-v3/V3L05-stamina-migration-l/oracle/stamina-contract.json'))"` |
| bundle shape | `python Scenarios-v3/V3L05-stamina-migration-l/verifiers/check_stamina_migration.py --bundle-shape-only` |
| reference candidate | `python Scenarios-v3/V3L05-stamina-migration-l/verifiers/check_stamina_migration.py --candidate-root <reference>/candidate --metrics-out <path>` |
