...
# V3L05 Stamina Migration (S variant)
...
| Check | Command |
|---|---|
| oracle JSON parse | `python -c "import json; json.load(open('Scenarios-v3/V3L05-stamina-migration-s/oracle/stamina-contract.json'))"` |
| bundle shape | `python Scenarios-v3/V3L05-stamina-migration-s/verifiers/check_stamina_migration.py --bundle-shape-only` |
| reference candidate | `python Scenarios-v3/V3L05-stamina-migration-s/verifiers/check_stamina_migration.py --candidate-root <reference>/candidate --metrics-out <path>` |
