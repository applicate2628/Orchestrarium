...
FROZEN_GENERATOR_PATH = "baseline/orchestrarium-v1/tooling/build_inventory.py"
DEVELOPMENT_GENERATOR_PATH = "scripts/baseline/build_inventory.py"
FROZEN_GENERATOR_MATERIALIZATION = "git-cat-file-reviewed-tree-blob"
OUTPUT_NAMES = (
...
def build_outputs(repo_root: Path, repository: str, requested_ref: str) -> dict[str, bytes]:
    ...
    manifest_payload = {
        ...
        "generator": {
            "command": f"python {FROZEN_GENERATOR_PATH}",
            "deterministic": True,
            "gitBlobSha": _git_blob_sha(Path(__file__).read_bytes()),
            "materialization": FROZEN_GENERATOR_MATERIALIZATION,
            "path": FROZEN_GENERATOR_PATH,
            "runtimeMutation": False,
            "sourcePath": DEVELOPMENT_GENERATOR_PATH,
        },
        "outputs": {
