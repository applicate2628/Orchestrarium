...
5. Is hand-rolling explicitly requested, or is it justified by evidence rather than convenience?

If the answer to 1 is yes and the answer to 5 is no, do not write the capability from scratch.
