...
| `DP3 — Independence` | Independence comes from different scope/framing and sealed fresh contexts, not vendor count. Candidates do not see sibling prompts, outputs, findings, or status before returning. |
