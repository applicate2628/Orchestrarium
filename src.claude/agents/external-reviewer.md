...
- `externalOpinionCounts` is a same-lane distinct-opinion contract; it does not cap how many same-provider review instances may run in parallel for different disjoint lanes or slices.
