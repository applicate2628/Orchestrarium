...
- when independent eligible external lanes are available, they may run in parallel; if native internal slot limits would otherwise block independent eligible lanes, prefer available external adapters over silent serialization or dropping a lane
