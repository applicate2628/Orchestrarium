...
- **Inline** (`Skill` tool, `/product-manager`): loads this contract into the CURRENT conversation, preserving accumulated context. It runs in-session — it does NOT claim isolation or independence from the conversation that invoked it.
