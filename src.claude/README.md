...
- `agents/*.md`, `agents/contracts/`, `agents/team-templates/`, and `agents/scripts/` define the runtime agent surface, including the Claude API wrapper under `agents/scripts/`
- `skills/` carries the preferred slash-skill helpers that ship with the pack, including `/agents-external-brigade` for bounded parallel external-helper brigades
