...
This directory contains the Claude-provider source tree for the standalone Claude branch.
...
This subtree is the Claude runtime source owned by this branch. Shared governance and shared references stay one level up; only the provider-specific runtime source lives here.
