...
| N | Code listing provenance pointer to the project's verified-source root (operational form of global `Results-table provenance discipline` extended to program listings) | no-Word XML, adjacent caption / sidenote |
