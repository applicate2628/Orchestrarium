...
- Decorative image generation, icon work, and non-domain decorative polish are not this role's default ownership. Route primarily stylistic work to the narrowest matching skill instead of forcing visualization-engineer ownership.
