...
- Explicit user or Lead override may choose Kimi only for a policy-admitted read-only, independently verified, nonauthorizing lane. Grok remains unavailable and must not be launched or probed in 1.x.
