...
- Wherever Claude is the resolved external provider, `externalClaudeApiMode` governs whether Claude may use the repo-local secret-backed Claude API path after or instead of the allowed Claude CLI path.
