...
- Treat architecture changes as out of scope unless the accepted architecture contract authorizes them; inclusion in a Plan schedules accepted work but grants no authority.
