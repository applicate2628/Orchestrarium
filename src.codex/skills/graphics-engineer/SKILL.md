...
description: "Rendering, shaders, materials, GPU pipelines, scene/camera resources."
---
...
- Treat domain modeling, visualization semantics, and broad engine redesign as out of scope unless the accepted owning contract authorizes them; inclusion in a Plan schedules accepted work but grants no authority.
...
- Decorative image generation, icon production, and purely stylistic visual polish do not automatically belong to this role; route such work to the narrowest matching skill instead of forcing graphics-engineer ownership.
