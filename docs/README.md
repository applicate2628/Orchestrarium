...
This directory is the docs surface for the standalone Codex pack.
...
- ../src.claude/README.md for the Claude source subtree
- ../src.gemini/README.md for the Gemini source subtree
- ../src.qwen/README.md for the Qwen source subtree
...
- ../references-gemini/README.md
- ../references-qwen/README.md
