...
Both Claude Code and Codex CLI expose hook surfaces; both production packs auto-install eight structural hooks — four blocking backstops and four warn-only audit hooks — plus three informational `SessionStart` reminders (eleven entries total):
