...
Both Claude Code and Codex CLI expose hook surfaces; both production packs auto-install five structural hooks — three blocking backstops and two warn-only audit hooks — plus one informational `SessionStart` reminder:
