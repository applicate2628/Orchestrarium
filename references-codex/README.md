...
This directory is the canonical provider-local reference tree for the standalone Codex branch.
...
These references are source-branch documentation only. They are not part of the installed runtime payload.
