...
- Старая игнорируемая директория `.plans/` — это legacy локальная история. Храните её только как scratch или материал трассируемости; датированные логи планов размещайте в `.plans/YYYY-MM/`.
