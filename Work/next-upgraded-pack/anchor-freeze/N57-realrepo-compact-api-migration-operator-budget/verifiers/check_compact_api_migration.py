...
def parse_args():
    parser = argparse.ArgumentParser(description="Check the N57 compact real-repo API migration bundle.")
...
def main():
    ...
    if args.bundle_shape_only:
        print("N57 verifier PASS (bundle shape)")
        return 0
    ...
    if args.expect_start_state:
        ...
        if missing:
            ...
            return 1
        print("N57 verifier PASS (expected start-state failures present)")
        return 0
