...
Score the run as a staged real-repo API migration task, not as a style rewrite.

- Correctness: structured APIs, hidden consumer behavior, owner boundaries, and error
  semantics.
