...
def parse_args():
    parser = argparse.ArgumentParser(description="Check the N36 staged real-repo API migration bundle.")
...
def main():
    ...
    contract = load_json(root / "oracle" / "staged-api-contract.json")
    ...
    if args.bundle_shape_only:
        print("N36 verifier PASS (bundle shape)")
        return 0
    ...
    if args.expect_start_state:
        ...
        if missing:
            ...
            return 1
        print("N36 verifier PASS (expected start-state failures present)")
        return 0
