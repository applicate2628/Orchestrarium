...
CONTRACT_PATH = (
    REPO_ROOT
    / "Scenarios-v2"
    / "N53-interface-refactor-cache-ignored-operator-budget"
    / "oracle"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Score N53 interface-refactor cache-ignored operator-budget run roots.")
