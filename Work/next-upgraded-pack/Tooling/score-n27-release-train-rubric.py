...
def parse_args():
    parser = argparse.ArgumentParser(description="Score N27 release train governor run roots.")
    parser.add_argument("run_roots", nargs="+", type=Path)
    parser.add_argument(
        "--scenario-root",
        type=Path,
        default=Path("Scenarios-v2/N27-release-train-governor-long-horizon-repeat-gauntlet"),
    )
