...
def parse_args():
    parser = argparse.ArgumentParser(description="Score N50 systems compact operator-budget run roots with a diagnostic rubric.")
    parser.add_argument("run_roots", nargs="+", type=Path)
    parser.add_argument(
        "--scenario-root",
        type=Path,
        default=Path("Scenarios-v2/N50-systems-compact-operator-budget-hotfix"),
    )
