...
| `x1-mainline-hardening-no-new-failures-2026-04-21.md` | admitted hardening record for `N06`, wave 2, `S06`, `S22`, `N14`, `N15`, `N16`, `N17`, `N18`, `N19`, `N20`, `N21`, `N22`, `N23`, `N24`, `N25`, `N26`, `N27`, `N28`, `N29`, `N30`, `N31`, and `N32` |
...
| `worker.default-implementation` | `S15`, `S19`, `S20`; plus `N14`, `N15`, `N16`, `N27`, `N28`, `N29`, and `N33` diagnostics | binary `PASS` across current top-pair pilots; `N29 96 / 100`; `N33 96 / 100`; exact interface migration passed but high output cost | binary `PASS` across current top-pair pilots; more compact on `N16`, `N27`, `N28`, `N29`, and `N33`; `N33 100 / 100` | partial baseline `1 / 3`; scoreable `N14 FAIL`; `N27 PASS`; `N28 FAIL`; `N29 FAIL`; `N33 FAIL 5 / 100` | baseline `3 / 3`; runtime `NOT-RUN` on N14; `N27/N28/N29 REQUEUE`; not admitted on N33 | baseline `3 / 3`; runtime `NOT-RUN` on N14; `N27/N28 ROUTE-FAIL`; `N29 RUNTIME-FAIL`; `N33 runtime no-summary` | `X3 primary` for compact long-horizon / cross-role / ownership-budget/interface-migration repairs; `X1` remains safe secondary, not a binary-lower row |
...
| cross-lane ranking | do not compare `N16`, `N19`, `N20`, `N21`, `N22`, `N23`, `N24`, `N25`, `N26`, `N27`, `N28`, `N29`, `N30`, `N31`, `N32`, `N33`, and `N34` as one global `0..100` leaderboard without splitting semantic and efficiency points |
...
| `$backend-engineer`, `$data-engineer`, `$platform-engineer` | `worker.default-implementation` | `X3 primary` for compact long-horizon, cross-role, ownership-budget, and interface-migration repairs | `X1` for verbose trace-heavy patch; `X2` calibration-only despite N27 pass | high for compact cross-role/interface work versus X1; low for binary correctness separation because N29/N33 tie | N14/N15/N16/N27/N28/N29/N33 keep the top-pair binary tie, while N16, N27, N28, N29, and N33 all favor X3 compactness/cost over X1; N28/N29/N33 separate X2 lower scoreably |
...
| interface refactor / migration patch | `X3 primary` for compact migration, `X1 secondary`; no top-pair binary split on N33 |
...
| interface refactor hypothesis | N33 confirmed top-pair binary tie but lower-row separation; next meaningful test should be a real-repo interface migration, not another synthetic hidden-consumer bundle |
