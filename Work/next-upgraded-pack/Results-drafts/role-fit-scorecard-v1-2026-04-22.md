...
| `worker.reasoning-constraints` | `S10`, `S11`, `S12`; plus `N18`, `N22`, `N31`, and `N32` scored rubrics | `PASS` on `N18`, `N22`, `N31`, and `N32`; `N22 100 / 100`, `N31 92 / 100`, `N32 97 / 100`; verbose but exact | `PASS` on `N18`, `N22`, `N31`, and `N32`; `N22 99 / 100`, `N31 94 / 100`, `N32 100 / 100`; much more compact | `PASS` on `N18`, scoreable `N22 FAIL`, scoreable `N32 FAIL 33`; calibration-only | `NOT-RUN` on N18 semantic timeout; not launched on N22/N31; `N32 REQUEUE` after smoke timeout | `ROUTE-FAIL` on N18 and N22; not launched on N31; `N32` runtime no-summary | co-primary for scientific/numerical correctness; N31/N32 add real physics analytical-oracle evidence, but no top-pair binary split |
...
| cross-lane ranking | do not compare `N16`, `N19`, `N20`, `N21`, `N22`, `N23`, `N24`, `N25`, `N26`, `N27`, `N28`, `N29`, `N30`, `N31`, and `N32` as one global `0..100` leaderboard without splitting semantic and efficiency points |
...
| `$algorithm-scientist`, `$computational-scientist`, `$security-engineer` | `worker.reasoning-constraints` | `X1` / `X3 near-tie`; choose by trace need versus compactness | `X2` calibration-only, not primary | medium | N18/N22/N31/N32 keep X1/X3 scoreable; N32 combines MoM and hydrogenic radial Schrodinger with analytical oracles and solver-runtime scoring, and still ties the top pair by binary correctness |
...
| scientist/constraint lane still lacks a binary top-pair split | treat `N18`, `N22`, `N31`, and `N32` as co-primary evidence; N32 combines real computational electromagnetics and hydrogenic radial Schrodinger with analytical oracles but still ties by binary |
| next scientific computation hardening | optional `W13`: high-load CEM/radial-Schrodinger performance gauntlet only if runtime separation is required |
