...
release-train semantics but fails output budget, while X3 passes all gates compactly. The explicit
...
| `x1-mainline-hardening-no-new-failures-2026-04-21.md` | admitted hardening record for `N06`, wave 2, `S06`, `S22`, and `N14..N54` |
...
| cross-lane ranking | do not compare `N16`, `N19`, `N20`, `N21`, `N22`, `N23`, `N24`, `N25`, `N26`, `N27`, `N28`, `N29`, `N30`, `N31`, `N32`, `N33`, `N34`, `N35`, `N36`, `N37`, `N38`, `N39`, `N40`, `N41`, `N42`, `N43`, `N44`, `N45`, `N46`, `N47`, `N48`, `N49`, `N50`, `N51`, `N52`, `N53`, and `N54` as one global `0..100` leaderboard without splitting semantic and efficiency points |
...
| long-horizon / cross-role / ownership-budget repair, compact patch, low output cost | `X3 primary` for single-session work, `X1 secondary`; `N45` confirms hidden report-consumer hardening still ties by binary while X3 wins cost, and `N46` plus `N54` turn explicit operator-budget into `X1 FAIL / X3 PASS` on repair and release-train lines; `X2` remains calibration-only and fails N28/N29/N41 scoreably |
...
| long-horizon, cross-role, and ownership-budget integration evidence | complete on both branches: `N16`, `N27`, `N28`, `N29`, and `N45` favor `X3` for compact single-session work by rubric/cost while tying by binary; `N46` and `N54` are low-noise/operator-budget compact separators in favor of `X3`; `N41` is a staged separator in favor of `X1` |
