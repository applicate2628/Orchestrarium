...
| `x1-mainline-hardening-no-new-failures-2026-04-21.md` | admitted hardening record for `N06`, wave 2, `S06`, `S22`, `N14`, `N15`, `N16`, `N17`, `N18`, `N19`, `N20`, `N21`, `N22`, `N23`, `N24`, `N25`, `N26`, `N27`, `N28`, `N29`, `N30`, and `N31` |
...
| `worker.reasoning-constraints` | `S10`, `S11`, `S12`; plus `N18`, `N22`, and `N31` scored rubrics | `PASS` on `N18`, `N22`, and `N31`; `N22 100 / 100`, `N31 92 / 100`; verbose but exact | `PASS` on `N18`, `N22`, and `N31`; `N22 99 / 100`, `N31 94 / 100`; much more compact | `PASS` on `N18`, scoreable `N22 FAIL`; calibration-only | `NOT-RUN` on N18 semantic timeout; not launched on N22/N31 | `ROUTE-FAIL` on N18 and N22; not launched on N31 | co-primary for scientific/numerical correctness; N31 adds real MoM analytical-oracle evidence and keeps X3's compactness edge |
...
| cross-lane ranking | do not compare `N16`, `N19`, `N20`, `N21`, `N22`, `N23`, `N24`, `N25`, `N26`, `N27`, `N28`, `N29`, `N30`, and `N31` as one global `0..100` leaderboard without splitting semantic and efficiency points |
...
| `$algorithm-scientist`, `$computational-scientist`, `$security-engineer` | `worker.reasoning-constraints` | `X1` / `X3 near-tie`; choose by trace need versus compactness | `X2` calibration-only, not primary | medium | N18/N22/N31 keep X1/X3 scoreable; N31 adds a real Method of Moments PEC-cylinder task with cylindrical-harmonic analytical oracle, and still reads X3 slightly ahead by compactness while X1 is faster |
...
| scientist/constraint decision memo or numerical physics solve with analytical oracle | `X1` / `X3 near-tie`; choose `X1` for trace-heavy/faster numerical evidence, `X3` for compact exact output |
...
| scientist/constraint lane still lacks a binary top-pair split | treat `N18`, `N22`, and `N31` as co-primary evidence; N31 is real computational electromagnetics with analytical oracle but still ties by binary |
| next scientific computation hardening | optional `W12`: hydrogenic radial Schrodinger or another real-physics numerical solve if the lane needs more than the MoM oracle |
