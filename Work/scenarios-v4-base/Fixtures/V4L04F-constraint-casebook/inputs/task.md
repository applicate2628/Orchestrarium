...
- LRU order is least-to-most-recent. Complete each mutation, including repeated evictions, before the next operation.
- Reopened ticks override a blackout only when the tick is also in an activity window.
