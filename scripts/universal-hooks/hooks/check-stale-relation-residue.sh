#!/usr/bin/env bash
# Thin wrapper around check-stale-relation-residue.py.
#
...
# stderr: an audit warning if stale-relation residue is written to a tracked file.
...
helper="$script_dir/check-stale-relation-residue.py"
