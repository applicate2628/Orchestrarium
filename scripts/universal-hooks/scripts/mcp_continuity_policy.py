...
TURN_ANCHOR_CONTEXT = (
    ...
    "Active-task continuity: a question, status check, or clarification does not end or"
    " replace the active task. Answer it briefly in the host's commentary/update channel,"
    " then in the same turn take the next authorized concrete action; do not send a final"
    " response or begin closeout merely because the question was answered. A standalone"
    " question with no active task may end normally. An explicit stop, pause, or cancel"
    " request, or a genuine decision only the user can make, overrides continuation. Never"
    " invent work or make useless tool calls merely to continue.\n"
