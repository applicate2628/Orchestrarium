...
description: Perform the security gate for an approved phase and return concrete findings or explicit approval. Use when Qwen Code needs independent review of auth or authz flows, secret handling, dependency risk, data exposure, dangerous configuration, or vulnerability triage before merge or release.
---
