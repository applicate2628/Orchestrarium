...
description: Formalize problem statements, invariants, objective functions, complexity tradeoffs, numerical stability, probabilistic assumptions, optimization strategy, and correctness arguments for algorithmic work before implementation. Use when Qwen Code needs mathematical framing, feasibility analysis, or proof-oriented guidance instead of code generation.
---
