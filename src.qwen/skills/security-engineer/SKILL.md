...
description: Define secure design constraints and threat-aware implementation requirements for an approved solution. Use when Qwen Code needs threat modeling, trust-boundary analysis, required security controls, secure defaults, or must-fix security constraints before planning or implementation.
---
