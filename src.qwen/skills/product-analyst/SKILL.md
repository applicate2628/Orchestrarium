...
description: Produce a factual pre-design product brief from available evidence. Use when Qwen Code needs user and business context, scope clarification, product constraints, relevant metrics, or open product questions before architecture or delivery planning begins.
---
