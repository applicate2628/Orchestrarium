...
description: External worker-side adapter for Qwen-line. Use when an eligible non-owner, non-review role should execute through Codex CLI or Claude CLI instead of a local specialist.
kind: local
max_turns: 16
---
