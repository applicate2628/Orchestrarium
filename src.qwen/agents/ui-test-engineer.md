...
description: Verify Qt UI regressions in approved phases. Use when Qwen Code needs independent checks for interaction states, keyboard and focus behavior, high-DPI rendering, theme variance, and screenshot or visual regressions on Qt surfaces before a phase advances.
---
