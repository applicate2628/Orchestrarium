...
EXPECTED_ALLOWED = {"candidate/workspace/src/workspace/recallWorkspaceRootAfterEdit.js"}


def parse_args():
    parser = argparse.ArgumentParser(description="Validate N09 changed paths stay in scope.")
...
def main():
    ...
    if allowed != EXPECTED_ALLOWED:
        print(f"ERROR: N09 allowed surface drifted: {sorted(allowed)}", file=sys.stderr)
        return 1
