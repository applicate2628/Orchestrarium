...
def parse_args():
    parser = argparse.ArgumentParser(description="Validate N08 changed paths stay in scope.")
...
def main():
    ...
    if allowed != EXPECTED_ALLOWED:
        print(f"ERROR: N08 allowed surface drifted: {sorted(allowed)}", file=sys.stderr)
        return 1
