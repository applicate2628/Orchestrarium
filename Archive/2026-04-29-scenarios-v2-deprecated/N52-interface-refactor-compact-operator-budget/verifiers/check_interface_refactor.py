...
def parse_args():
    parser = argparse.ArgumentParser(description="Check the N52 interface-refactor compact operator-budget gauntlet.")
...
def main():
    ...
    if args.bundle_shape_only:
        print("N52 verifier PASS (bundle shape)")
        return 0
    ...
    if args.expect_start_state:
        ...
        if missing:
            ...
            return 1
        print("N52 verifier PASS (expected start-state failures present)")
        return 0
