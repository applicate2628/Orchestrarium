...
def parse_args():
    parser = argparse.ArgumentParser(description="Check the N38 UI/visual/state integration bundle.")
...
def main():
    ...
    if args.bundle_shape_only:
        print("N38 verifier PASS (bundle shape)")
        return 0
    ...
    if args.expect_start_state:
        ...
        if observed != expected:
            ...
            return 1
        print("N38 verifier PASS (expected start-state failures present)")
        return 0
