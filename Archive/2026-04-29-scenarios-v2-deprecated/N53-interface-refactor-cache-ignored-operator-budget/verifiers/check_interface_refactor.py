...
def parse_args():
    parser = argparse.ArgumentParser(description="Check the N53 interface-refactor cache-ignored operator-budget gauntlet.")
...
def main():
    ...
    if args.bundle_shape_only:
        print("N53 verifier PASS (bundle shape)")
        return 0
    ...
    if args.expect_start_state:
        ...
        if missing:
            ...
            return 1
        print("N53 verifier PASS (expected start-state failures present)")
        return 0
