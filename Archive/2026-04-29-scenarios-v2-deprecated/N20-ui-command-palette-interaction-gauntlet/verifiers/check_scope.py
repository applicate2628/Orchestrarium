...
def parse_args():
    parser = argparse.ArgumentParser(description="Check N20 changed paths stay in scope.")
...
def main():
    ...
    contract = json.loads((root / "oracle" / "ui-contract.json").read_text(encoding="utf-8"))
    ...
    if unexpected:
        ...
        return 1
    print("N20 scope PASS (changed paths are in bounds)")
    return 0
