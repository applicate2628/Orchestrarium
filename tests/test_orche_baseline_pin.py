...
class BaselinePinTests(unittest.TestCase):
    def test_pin_matches_exact_main_git_object(self) -> None:
    ...
    def test_readme_repeats_main_pin_and_local_commands(self) -> None:
        ...
        self.assertIn("scripts/validate-agents-mode-installers.py --root .", readme)
        self.assertIn("scripts/baseline/compare_pytest_baseline.py", readme)
