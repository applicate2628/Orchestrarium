...
def parse_args():
    parser = argparse.ArgumentParser(description="Check the N29 incident-driven integration repair gauntlet.")
...
def evaluate_repair_ledger(root: Path):
    ...
    def patch_budget_ledger(ledger):
        ...
        assert_equal(budget.get("maxChangedPaths"), 4, "maxChangedPaths")
...
def main():
    ...
    if args.bundle_shape_only:
        ...
        mode = "completed run"
    print(f"N29 verifier PASS ({mode})")
    return 0
