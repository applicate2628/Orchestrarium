...
def parse_args():
    parser = argparse.ArgumentParser(description="Check N51 changed paths stay in immutable-CI turnaround-budget scope.")
...
def main():
    ...
    print("N51 scope PASS (immutable-CI changed paths are in bounds)")
    return 0
