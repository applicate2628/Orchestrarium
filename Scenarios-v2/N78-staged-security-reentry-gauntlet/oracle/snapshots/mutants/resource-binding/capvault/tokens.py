...
# MUTANT class-id=resource-binding: the token's resource_id is no longer bound to
# expected_resource. All other checks are the correct reference logic. Detect by
# authorizing a valid token against a DIFFERENT expected_resource and asserting denial
# -> 'resource-binding undetected'.
