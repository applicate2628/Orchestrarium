...
def parse_args():
    parser = argparse.ArgumentParser(description="Check the N35 staged interface migration bundle.")
...
def main():
    ...
    if args.bundle_shape_only:
        print("N35 verifier PASS (bundle shape)")
        return 0
    ...
    if args.expect_start_state:
        ...
        if missing:
            ...
            return 1
        print("N35 verifier PASS (expected start-state failures present)")
        return 0
