...
def parse_args():
    parser = argparse.ArgumentParser(description="Check N42 changed paths stay in immutable-CI scope.")
...
def main():
    ...
    print("N42 scope PASS (immutable-CI changed paths are in bounds)")
    return 0
