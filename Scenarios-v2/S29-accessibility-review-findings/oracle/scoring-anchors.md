...
|---|---|---|
| `correctness` | identifies the two blocking findings and three major findings, then returns `REVISE` | misses a blocking accessibility issue or lets the dialog pass |
