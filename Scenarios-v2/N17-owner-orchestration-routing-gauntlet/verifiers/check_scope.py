...
def parse_args():
    parser = argparse.ArgumentParser(description="Check N17 changed paths stay in scope.")
...
def main():
    ...
    contract = json.loads((root / "oracle" / "owner-routing-contract.json").read_text(encoding="utf-8"))
    ...
    if unexpected:
        ...
        return 1
    print("N17 scope PASS (changed paths are in bounds)")
    return 0
