...
def parse_args():
    parser = argparse.ArgumentParser(description="Check the N79 UI/visual/state reentry bundle.")
...
def main():
    ...
    if args.bundle_shape_only:
        print("N79 verifier PASS (bundle shape)")
        return 0
    ...
    if args.expect_start_state:
        ...
        if observed != expected:
            ...
            return 1
        print("N79 verifier PASS (expected start-state failures present)")
        return 0
