...
This is a compact surgical hotfix lane. The runner transcript is part of the artifact budget:
...
The operator-budget gate will also fail the run if the benchmark worker transcript exceeds the
declared `40000` byte budget. This is a scoreable requirement for this lane, not a post-run style
preference.
