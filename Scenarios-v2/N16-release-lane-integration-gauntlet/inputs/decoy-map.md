...
| `candidate/workspace/ui/release_badges.py` | maps release statuses to display labels only |

Fix the owned releaseflow modules instead of adapting these decoys.
