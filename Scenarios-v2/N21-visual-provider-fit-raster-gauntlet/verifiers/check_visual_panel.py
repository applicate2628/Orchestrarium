...
def parse_args():
    parser = argparse.ArgumentParser(description="Check the N21 visual raster panel bundle.")
...
def import_candidate_module(root: Path):
    ...
    spec = importlib.util.spec_from_file_location("n21_candidate_renderer", module_path)
...
def main():
    ...
    if args.bundle_shape_only:
        ...
        mode = "completed run"
    print(f"N21 verifier PASS ({mode})")
    return 0
