...
description: Formalize physics, simulation, and numerical-method work before implementation. Use when Gemini CLI needs governing equations, units, discretization strategy, solver choice, convergence or stability analysis, error bounds, physical assumptions, or validation criteria for math, physics, or simulation-heavy problems.
---
