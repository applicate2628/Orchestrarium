...
description: Define reliability constraints for a change before planning or implementation. Use when Gemini CLI needs SLO targets, failure-mode analysis, resilience patterns, degradation behavior, observability requirements, rollout and rollback safety, or recovery readiness for an approved solution.
---
