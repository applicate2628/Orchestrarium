---
name: ux-reviewer
description: Perform an independent UX gate for approved user-facing changes. Use when Gemini CLI needs blocking review for usability, interaction clarity, accessibility, content comprehension, or flow integrity before merge or release.
---
