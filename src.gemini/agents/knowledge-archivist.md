...
description: Maintain repository knowledge hygiene without taking product delivery ownership. Use when Gemini CLI needs documentation updates, plan or report curation, ADR or reference maintenance, repository structure cleanup, canonical-source alignment, or archival consistency for accepted artifacts and decisions.
---
