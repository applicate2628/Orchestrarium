...
- `skills/` carries the full Gemini role-skill catalog for the shared role vocabulary — one universal skill per role, the cross-tool surface read by Gemini CLI and Antigravity.
- `skills/lead/team-templates/` carries the repo-local team compositions for the shared role principle.
...
- the role catalog and orchestration both live in `skills/` (one universal skill per role)
