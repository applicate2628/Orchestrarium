...
description: Implement an approved backend phase without redesigning the system. Use when Gemini CLI needs server-side, API, domain, persistence, or integration changes that already have accepted research, design, specialist constraints, and plan artifacts.
---
