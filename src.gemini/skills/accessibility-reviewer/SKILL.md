...
description: Perform an independent accessibility gate for approved phases. Use when Gemini CLI needs blocking review of keyboard access, focus order, semantic labeling, contrast, assistive technology exposure, and other accessibility risks before merge or release.
---
...
1. Tag the finding: `[CROSS-DOMAIN: <target-domain>]` (e.g., `[CROSS-DOMAIN: ux]`, `[CROSS-DOMAIN: architecture]`).
