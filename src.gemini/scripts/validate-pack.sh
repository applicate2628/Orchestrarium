...
! grep -Fq 'do not auto-install the production Codex/Claude helper or hook surfaces' "$PACK_ROOT/skills/lead/subagent-contracts.md" || fail "subagent contracts should not describe Gemini hook/helper surfaces as absent"
