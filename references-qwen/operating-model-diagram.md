...
Platform note: the diagrams below describe Orchestrarium governance flow on the Qwen line. They are not a claim about every Qwen Code-native execution detail or runtime optimization.
...
- Keep runtime surfaces official-first: `QWEN.md`, `/init`, `.qwen/settings.json`, and `qwen-extension.json`.
