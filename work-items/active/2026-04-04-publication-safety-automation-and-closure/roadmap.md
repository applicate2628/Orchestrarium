...
- Rationale: The repository now has publication-safety policy and periodic controls, but publication safety is still mostly human-driven and completed items still lack a formal closure artifact and archive-ready closing rule.
...
- Non-goals: CI integration, GitHub Actions, retroactive history scanning, binary-file scanning, or broad workflow redesign beyond the new automation and closure-artifact layer.
